###### consistency and motif analysis for YY1
...
## load called peaks
bams <- c('wgEncodeHaibTfbsGm12878Yy1sc281Pcr1xRawDataRep1.bam','wgEncodeHaibTfbsGm12878Yy1sc281Pcr1xRawDataRep2.bam',
          'wgEncodeSydhTfbsGm12878Yy1RawDataRep1.bam','wgEncodeSydhTfbsGm12878Yy1RawDataRep2.bam')
...
compare2(gcapc,spp,withinlab=FALSE,main="YY1 GM12878",labs=labs,legends=c("gcapc","SPP"),ranks=seq(800,10000,50),ylim=c(0,0.6))
...
pwm <- round(PWM(YY1.MA0095.2,prior.params = c(A=0.3, C=0.2, G=0.2, T=0.3)),3)
...
for(i in 1:4){
    ...
    if(i==1) {
        plot(steps,prop1,type='l',
             ...
             ylim=c(0,0.25),col=colors[1],lty=2)
